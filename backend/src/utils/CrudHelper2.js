...
export const readTable = (table, conditions, connection) => {
    return new Promise((resolve, reject) => {
...
export const update = (table, data, conditions, connection) => {
    return new Promise((resolve, reject) => {
        const sql = `UPDATE ${mysql2.escapeId(table)} SET ? WHERE ?`;
...
export const remove = (table, conditions, connection) => {
    return new Promise((resolve, reject) => {
        const sql = `DELETE FROM ${mysql2.escapeId(table)} WHERE ?`;
...
export const executeCustomQuery1 = (sql, data, connection) => {
    return new Promise((resolve, reject) => {
        const values = [];
        values.push(data);
        console.log(sql);
...
// Execute a custom SQL query
export const executeCustomQuery = (sql, connection) => {
    return new Promise((resolve, reject) => {
